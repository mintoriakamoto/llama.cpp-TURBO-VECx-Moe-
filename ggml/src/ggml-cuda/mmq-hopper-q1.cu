...
bool ggml_cuda_mul_mat_q1_hopper(ggml_backend_cuda_context & ctx,
    ...
    // Q2_0 arm disabled: this kernel's repack assumes the fork's 128-weight
    // Q2_0 blocks, but this tree carries upstream's 64-weight Q2_0 layout.
    const bool    is_q2 = false;
